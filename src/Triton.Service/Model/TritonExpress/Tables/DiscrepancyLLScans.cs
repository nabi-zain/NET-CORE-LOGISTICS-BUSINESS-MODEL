...
{
    [Table("DiscrepancyLLScans")]
    public class DiscrepancyLLScans
    {
        [Dapper.Contrib.Extensions.Key]
        public long DiscrepancyLLScansID { get; set; }
        ...
        [DisplayName("Date")]
        [Required(ErrorMessage = "LLScan Date Captured Value is required!")] // Field validation message
